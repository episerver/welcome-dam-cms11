namespace Optimizely.Labs.WelcomeDAM
{
    public static class WelcomeConstants
    {
        ...
        public const string AccountsBaseUrl = "https://accounts.welcomesoftware.com/";

        public const string APIBaseUrl = "https://api.welcomesoftware.com/";
        ...
        public const string ProviderKey = "welcome-cp";

        public const string ProviderName = "Welcome";
        ...
        public const string ModuleName = "WelcomeDAM";
    }
}